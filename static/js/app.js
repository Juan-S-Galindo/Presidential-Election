...
async function initiateModel(zipInput, employmentInput, amountInput) {
    const responseData = await d3.json("https://election-app-test.herokuapp.com/model/" + zipInput + "/" + employmentInput + "/" + amountInput).then(responseData => displayResults(responseData));
